    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-5">
                ...
                <div class="text-2xl font-bold text-gray-900 dark:text-gray-100 tracking-tight">${{ number_format($totalCollected, 2) }}</div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-5">
                ...
                <div class="text-2xl font-bold text-gray-900 dark:text-gray-100 tracking-tight">${{ number_format($totalFees, 2) }}</div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-5">
                ...
                <div class="text-2xl font-bold text-gray-900 dark:text-gray-100 tracking-tight">${{ number_format($outstandingBalance, 2) }}</div>
                            ...
                            <tbody class="divide-y divide-gray-50 dark:divide-gray-700/50 text-sm">
                                @forelse($recentPayments as $payment)
                                    <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/30 transition-colors">
                                        ...
                                        <td class="py-3 pr-4 font-semibold text-emerald-600 dark:text-emerald-400">${{ number_format($payment->amount, 2) }}</td>
                    ...
                    <div class="space-y-3">
                        @forelse($categoryBreakdown as $category)
                            <div class="flex items-center justify-between py-2 border-b border-gray-50 dark:border-gray-700/50 last:border-0">
                                ...
                                <span class="text-sm font-semibold text-gray-700 dark:text-gray-300">${{ number_format($category->student_fees_sum_amount ?? 0, 2) }}</span>
                            </div>
                        @empty
