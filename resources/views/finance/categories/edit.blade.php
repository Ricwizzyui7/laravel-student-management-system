<x-app-layout>
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6">
            <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-6">{{ __('Edit Fee Category') }}</h2>
            ...
            <form method="POST" action="/finance/categories/{{ $feeCategory->id }}">
                ...
                <div class="flex items-center gap-3">
                    <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm rounded-xl px-6 py-2.5 shadow-sm transition">{{ __('Update Category') }}</button>
