<x-app-layout>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 tracking-tight">{{ __('System Settings') }}</h1>
            <p class="text-gray-500 dark:text-gray-400 mt-2">{{ __('Configure system-wide settings and institution information.') }}</p>
        </div>
