<div class="space-y-6">
    {{-- Name --}}
    <div class="max-w-md">
        <h2 class="text-lg font-semibold text-gray-900 mb-4">Institution Name</h2>
        <form method="POST" action="{{ route('settings.admin.institution') }}" class="space-y-4">
            ...
            <div>
                ...
                <input id="institution_name" name="institution_name" type="text" value="{{ $settings['institution_name'] }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
    ...
    <div class="border-t pt-6">
        <h2 class="text-lg font-semibold text-gray-900 mb-4">Institution Logo</h2>
        <form method="POST" action="{{ route('settings.admin.logo') }}" enctype="multipart/form-data" class="space-y-4">
            @csrf
            <div class="flex items-center gap-6">
                <div class="h-20 w-32 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center shrink-0">
                ...
                <div>
                    <label for="institution_logo" class="block text-sm font-semibold text-gray-700 mb-2">
                        Choose Logo
                    </label>
                    <input id="institution_logo" name="institution_logo" type="file" accept="image/*" class="block w-full text-sm text-gray-500
                    ...
                    <p class="text-xs text-gray-500 mt-1">Max 2 MB. PNG recommended for transparency.</p>
