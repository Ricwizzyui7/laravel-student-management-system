<div class="space-y-6">
    {{-- Name --}}
    <div class="max-w-md">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">{{ __('Institution Name') }}</h2>
    ...
    <div class="border-t pt-6">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">{{ __('Institution Logo') }}</h2>
            ...
            <div class="flex items-center gap-6">
                <div class="h-20 w-32 rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-900 flex items-center justify-center shrink-0">
                    @if($settings['institution_logo'])
                        <img src="{{ Storage::url($settings['institution_logo']) }}" alt="{{ __('Logo') }}" class="h-full w-full object-contain p-2">
                    @else
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ __('Max 2 MB. PNG recommended for transparency.') }}</p>
