<div class="max-w-md">
    ...
    <form method="POST" action="{{ route('settings.admin.contact') }}" class="space-y-4">
        ...
        <div>
            ...
            <input id="contact_email" name="contact_email" type="email" value="{{ $settings['contact_email'] }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
        ...
        <div>
            ...
            <input id="contact_phone" name="contact_phone" type="tel" value="{{ $settings['contact_phone'] }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
        ...
        <div>
            ...
            <textarea id="contact_address" name="contact_address" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ $settings['contact_address'] }}</textarea>
