<div class="max-w-md space-y-6">
    {{-- Theme --}}
    <div>
        <h2 class="text-lg font-semibold text-gray-900 mb-4">Theme</h2>
        <form method="POST" action="{{ route('settings.user.theme') }}" class="space-y-3">
            ...
            <div class="space-y-2">
                @foreach(['system' => 'System (Auto)', 'light' => 'Light', 'dark' => 'Dark'] as $value => $label)
                    <label class="flex items-center gap-3 cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition" :class="{'border-blue-500 bg-blue-50' : '{{ $user->theme }}' === '{{ $value }}'}">
    ...
    <div class="border-t pt-6">
        <h2 class="text-lg font-semibold text-gray-900 mb-4">Language</h2>
