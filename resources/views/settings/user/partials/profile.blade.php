<div class="space-y-6">
    <div>
        <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">{{ __('Profile Picture') }}</h2>
        <form method="POST" action="{{ route('settings.user.profile-picture') }}" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="flex items-center gap-6">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ __('Max 5 MB. JPG, PNG, GIF') }}</p>
    ...
    <div class="border-t pt-6">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">{{ __('Account Information') }}</h2>
        <div class="space-y-4">
            <div>
