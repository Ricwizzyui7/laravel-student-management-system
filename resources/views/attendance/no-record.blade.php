<x-app-layout>
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-10 text-center">
            ...
            <h1 class="text-lg font-bold text-gray-900 dark:text-gray-100">{{ __('No Student Record Linked') }}</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-2 max-w-md mx-auto">
                {{ __("Your account isn't linked to a student profile yet, so there's no attendance to display.") }}
                {{ __('Please ask an administrator to link your account to your student record.') }}
            </p>
