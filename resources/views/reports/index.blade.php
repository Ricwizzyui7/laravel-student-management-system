<x-app-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 tracking-tight">Reports</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Generate professional PDF reports. Preview in-browser or download.</p>
        </div>
