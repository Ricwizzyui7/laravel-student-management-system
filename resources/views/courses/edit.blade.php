    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
            <div class="p-6 sm:p-8 border-b border-gray-50 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50">
                <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100">Edit Course</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Update the details for <span class="font-semibold text-gray-700 dark:text-gray-300">{{ $course->name }}</span>.</p>
            </div>
            ...
            <form action="{{ route('courses.update', $course->id) }}" method="POST" class="p-6 sm:p-8 space-y-6 m-0">
                ...
                <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-50 dark:border-gray-700">
                    <a href="{{ route('courses.index') }}" class="inline-flex items-center justify-center bg-gray-100 dark:bg-gray-900 hover:bg-gray-200 text-gray-700 dark:text-gray-300 font-semibold text-sm rounded-xl px-5 py-2.5 transition">Cancel</a>
